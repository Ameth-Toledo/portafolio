...
import { EstructuraDirectoriosComponent } from '../../core/components/estructura-directorios/estructura-directorios.component';

@Component({
  selector: 'app-arquitectura-hexagonal',
  standalone: true,
  imports: [CommonModule, CardTecnologyComponent, CardEditorCodeComponent, TecnologiasComponent, EstructuraDirectoriosComponent],
