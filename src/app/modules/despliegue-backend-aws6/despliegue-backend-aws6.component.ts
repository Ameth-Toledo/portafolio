...
@Component({
  selector: 'app-despliegue-backend-aws6',
  standalone: true,
  imports: [CardTecnologyComponent, ImagesComponent, TecnologiasComponent, ComandCopyComponent],
  templateUrl: './despliegue-backend-aws6.component.html',
  styleUrl: './despliegue-backend-aws6.component.css'
})
export class DespliegueBackendAws6Component {
  constructor(
  ...
  sendToDeployAWS2(event: Event) {
    event.preventDefault();
    this.router.navigate(['despliegue/backend/aws/ec2/id=8']).then(() => {
