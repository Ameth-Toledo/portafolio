...
@Component({
  selector: 'app-despliegue-backend-aws3',
  standalone: true,
  imports: [CardTecnologyComponent, ImagesComponent, TecnologiasComponent, ComandCopyComponent],
  templateUrl: './despliegue-backend-aws3.component.html',
  styleUrl: './despliegue-backend-aws3.component.css'
})
export class DespliegueBackendAws3Component {
constructor(
