...
@Component({
  selector: 'app-despliegue-base-de-datos-aws1',
  standalone: true,
  imports: [TecnologiasComponent, ImagesComponent, CardTecnologyComponent, ComandCopyComponent],
  templateUrl: './despliegue-base-de-datos-aws1.component.html',
  styleUrl: './despliegue-base-de-datos-aws1.component.css'
})
export class DespliegueBaseDeDatosAws1Component {
constructor(
