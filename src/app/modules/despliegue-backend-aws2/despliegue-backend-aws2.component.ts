...
@Component({
  selector: 'app-despliegue-backend-aws2',
  standalone: true,
  imports: [CardTecnologyComponent, ImagesComponent, TecnologiasComponent],
  templateUrl: './despliegue-backend-aws2.component.html',
  styleUrl: './despliegue-backend-aws2.component.css'
})
export class DespliegueBackendAws2Component {
constructor(
