...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Angular Specialist</span> <span className="text-primary/60">✦</span>
    <span>FullStack Developer</span> <span className="text-secondary/60">✦</span>
    <span>React · Vue · Angular</span> <span className="text-primary/60">✦</span>
    <span>Go · Java · Python</span> <span className="text-secondary/60">✦</span>
    <span>MySQL · PostgreSQL</span> <span className="text-primary/60">✦</span>
  </div>
);
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              <div className="flex flex-wrap justify-center gap-4 w-full">
                <MagneticButton
                  as="a"
                  href="https://github.com/Ameth-Toledo"
                  target="_blank"
                ...
                >
                  <span className="text-muted-foreground group-hover:text-foreground transition-colors"><GitHubIcon /></span>
                  GitHub
                </MagneticButton>

                <MagneticButton
                  as="a"
                  href="https://www.linkedin.com/in/ameth-de-jes%C3%BAs-m%C3%A9ndez-toledo/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="footer-glass-pill px-10 py-5 rounded-full text-foreground font-bold text-sm md:text-base flex items-center gap-3 group"
                >
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-6 w-full mt-2">
                {["Proyectos", "Sobre Mí", "Blog", "Certificaciones"].map((label) => (
                  <MagneticButton
                    key={label}
                    as="a"
                    href={`#${label.toLowerCase().replace(/\s/g, '-').replace('í', 'i')}`}
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest uppercase order-2 md:order-1">
              © 2026 Ameth Toledo. Todos los derechos reservados.
            </div>
