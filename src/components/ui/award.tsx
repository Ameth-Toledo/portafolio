...
export function Awards({
    ...
    return (
      <div className={cn("relative mx-auto flex h-48 w-48 items-center justify-center", className)}>
        ...
        <div className="relative z-10 text-center">
          {showIcon && <div className="mb-1 flex justify-center text-center text-2xl"><Star className="text-primary fill-primary" /></div>}
  ...
  if (variant === "award") {
    ...
    return (
      <div className={cn("relative z-0 flex flex-col items-center justify-center p-6 overflow-hidden", className)}>
        <LaurelWreath />
  ...
  if (variant === "badge") {
    const BadgeIcon = () => (
      <svg className={cn("fill-primary h-full w-18 overflow-hidden")} width="500.15" height="620.78" viewBox="0 0 500.15 620.78">
        ...
        <path d="M238.82,68.07C104.43,76.3,30.99,231.31,110.21,341.1c68.96,95.57,211.43,95.17,280.04-.59,84.76-118.31-7.09-281.26-151.43-272.43Z" />
    ...
    return (
      <div className={cn("relative inline-flex -rotate-5 transform items-center justify-center", className)}>
        <div className="relative text-center">
          {[...Array(6)].map((_, i) => (
            <span key={i} className={`absolute ${i % 2 === 0 ? 'hidden dark:block' : 'block dark:hidden'} text-7xl font-black tracking-tighter`}
              style={{ transform: `translate(${(6 - i) * 2}px, ${(6 - i) * 2}px)`, WebkitTextStroke: `10px ${i % 2 === 0 ? 'white' : 'black'}` }}>
              {title}
            </span>
          ))}
          <span className="text-primary relative text-7xl font-black tracking-tighter"
