...
export function JavalinInstalarJavaLesson() {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="px-6 pt-28 pb-10 sm:px-12 lg:px-24 border-b border-border">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="font-mono text-xs tracking-widest text-[#C3E41D] uppercase mb-2">
            Módulo 4 · Deploy de API Rest con Javalin
          </p>
      ...
      <div className="px-6 sm:px-12 lg:px-24 py-12">
        <div className="max-w-5xl mx-auto">
          ...
          <Section title="Conectarse a la instancia y actualizar paquetes">

            <Step number={1} title="Abrir la consola de EC2 y actualizar el sistema">
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                Da clic en <strong className="text-foreground">Conectar</strong> sobre la
                instancia de backend. Se abrirá la consola en el navegador. Lo primero es
              ...
              <div className="grid sm:grid-cols-2 gap-4 mt-4">
                <Screenshot
                  src={`${BASE}/aws25.png`}
                  alt="Botón Conectar en la instancia backend"
                  caption="Clic en Conectar para abrir la consola"
                />
                <Screenshot
                  src={`${BASE}/aws26.png`}
                  alt="Actualización de paquetes en la consola"
          ...
          <Section title="Instalar y verificar Java">

            <Step number={2} title="Instalar Java">
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                Vamos a instalar Java. En este ejemplo se usa la versión{' '}
                <strong className="text-foreground">11</strong>. Si trabajas con una versión
                diferente, solo cambia el número <strong className="text-foreground">11</strong>{' '}
                por la versión que estés utilizando en ambos paquetes del comando:
              </p>

              <CommandBlock command="sudo apt install openjdk-11-jdk openjdk-11-jre -y" />

              <Callout type="tip">
                El paquete <strong className="text-foreground">jdk</strong> incluye el kit de
                desarrollo y el <strong className="text-foreground">jre</strong> es el entorno
                de ejecución. Para un servidor solo el jre sería suficiente, pero instalar
                ambos garantiza compatibilidad con cualquier proyecto.
              </Callout>
            </Step>

            <Step number={3} title="Verificar la instalación">
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                Una vez terminada la instalación, verifica que Java quedó correctamente
                configurado ejecutando:
              </p>

              <CommandBlock command="java --version" />

              <p className="text-muted-foreground text-sm leading-relaxed mt-3 mb-4">
                La consola mostrará la versión instalada. Si aparece el número de versión
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Screenshot
                  src={`${BASE}/aws27.png`}
                  alt="Instalación de Java en progreso"
                  caption="Instalación de openjdk-11"
                />
                <Screenshot
                  src={`${BASE}/aws28.png`}
                  alt="Verificación de la versión de Java"
                  caption="java --version muestra la versión instalada"
                />
              </div>
            </Step>
